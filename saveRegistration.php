...
<body>
  ...
  <h3 style="margin-top: 15px;
			   text-align: center">Registered Users</h3>
  <table style="margin-top: 15px;
    ...
    <tr>
      <td>User Password</td>
      <td>:</td>
      <td><b><?php print($adPassword) ?></b></td>
    </tr>
    <tr>
      <td>User Contact</td>
      <td>:</td>
  ...
  //create query
  $sql = "INSERT INTO users (userName, userContact, userEmail, userPassword) VALUES ('$adName', '$adContact', '$adEmail', '$adPassword')";
  ...
  <a href="signIn.html"><button class="btn" style="margin-left: 595px">Log In</button></a>
